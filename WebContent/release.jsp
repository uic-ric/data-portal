...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="edu.uic.rrc.portal.ProjectsServlet,edu.uic.rrc.portal.model.entities.Release,edu.uic.rrc.portal.model.entities.ProjectFiles,edu.uic.rrc.portal.model.entities.User,
java.text.DateFormat,java.text.SimpleDateFormat,java.util.List,edu.uic.rrc.portal.listener.ProjectSyncScheduleListener,edu.uic.rrc.portal.model.entities.arvados.Group" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<p><strong>Project:</strong><a class="btn btn-link" href="<%= request.getContextPath() %>/projects/<%= proj.getUuid()%>"><%= proj.getName() %></a><br>
...
<%-- <div class="row">
	<div class="col-sm-12">
	<a href="<%= request.getContextPath() %>/zip?release=<%= release.getReleaseID() %>" class="btn btn-link"><span class="glyphicon glyphicon-import"></span> Download ZIP archive</a>			 			
	</div>
</div> --%>
